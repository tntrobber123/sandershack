...
class Level(BaseComponent):
    ...
    def add_xp(self, xp: int) -> None:
        ...
        self.current_xp += (xp * self.xp_mod)

        self.engine.message_log.add_message(f"You gain {xp * self.xp_mod} experience points.")
    ...
    def increase_power(self, amount: int = 10) -> None:
    ...
    def increase_defense(self, amount: int = 10) -> None:
